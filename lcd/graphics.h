 ...
 *      Author: RobG
 *
 *  Functions to write fancy stuff to a display.
 */
#ifndef GRAPHICS_H_
#define GRAPHICS_H_
...
void drawString(uint8_t x, uint8_t y, const char type, const char *string);
void drawCharLg(uint8_t x, uint8_t y, const char c);
void drawCharMd(uint8_t x, uint8_t y, const char c);
void drawCharSm(uint8_t x, uint8_t y, const char c);
void drawCharLgBkg(uint8_t x, uint8_t y, const char c);
void drawCharMdBkg(uint8_t x, uint8_t y, const char c);
void drawCharSmBkg(uint8_t x, uint8_t y, const char c);
